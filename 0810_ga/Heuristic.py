...
class GA:
    ...
    def generate_child_chromosomes(self, parent_chromosomes, parent_fitness):
        one_valid = True 
        two_valid = True
        ...
        #print("자손 1: ", child1)
        #print("자손 2:", child2)
        #print("자손 유전자: ", child_chromosomes)
    ...
    def global_search(self, num_of_chrom, num_of_generations, problem : Problem):
        ...
        while no_update < 10 and generation <= num_of_generations:
            ...
            print('\t자손 염색체 생성중...')
            children_chromosomes = self.generate_child_chromosomes(parent_chromosomes, parent_fitness)
            print('\t자손 염색체 생성완료.')
            ...
            num_by_fitness = int(len(parent_chromosomes) * 0.9)#다음 세대가 될 염색체들 중 적합도가 높아 선택된 염색체들의 비율
